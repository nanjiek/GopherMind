...
var requiredTables = []string{
	...
	"clinical_events", "projection_checkpoints", "outbox_messages", "agent_runs", "agent_steps", "agent_run_checkpoints", "agent_tasks", "agent_task_dependencies", "agent_mailbox_messages", "agent_committed_responses", "session_compactions",
}
