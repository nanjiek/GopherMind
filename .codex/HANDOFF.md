...
- Working tree: expected clean after this checkpoint update is committed; component startup code is ahead of `origin/codex/p1-step2-event-surface`.
...
- P2 Step 2 has no PR yet; it must use `codex/p1-step2-event-surface` as its base.
...
1. Commit this refreshed checkpoint, push `codex/p2-step2-component-startup`, and create its PR against `codex/p1-step2-event-surface`.
